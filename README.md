# LipReLU
This repository is the code for paper **"Enhancing Node-Level Adversarial Defenses by Lipschitz Regularization of Graph Neural Networks"** in Proceedings of the 29th ACM SIGKDD Conference on Knowledge Discovery and Data Mining. In addition, because of the page limit of KDD2023, some experimental results can't be placed in the paper, we place them here.
