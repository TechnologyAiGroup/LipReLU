...
parser.add_argument('--ptb_rate', type=float, default=0.05,  help='pertubation rate')    # 0.23替换0.25
...
# # path_2 = "examples/graph/topology_modified_adj/cora_topology_modified_adj_ptb_rate_0.10.pt"
