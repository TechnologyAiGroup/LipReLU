...
print("perturbed_adj:", perturbed_adj)
print('______________________________________________________')
model.fit(features, perturbed_adj, labels, idx_train, idx_val, threshold=0.03, lip_norm=False, lip_node=False, lip_relu=False, gamma=0.01, verbose=True)
model.eval()
